...
def generate_launch_description():
    ...
    this_dir = get_package_share_directory("bringup")
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(this_dir, "maps", "tb3_sandbox.yaml"),
    )
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        default_value=os.path.join(this_dir, "params", "nav2_params.yaml"),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(this_dir, "rviz", "nav2_default_view.rviz"),
